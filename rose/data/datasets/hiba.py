...
class HIBA(Dermoscopy):
    ...
    def _entries_path(self):
        return f"hiba-entries-{self._split.value.upper()}.npy"
    ...
    def get_image_data(self, index: int) -> bytes:
        ...
        image_full_path = os.path.join(self.ssl_data, "HIBA", entry["image_id"] + ".jpg")
