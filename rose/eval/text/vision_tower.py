...
from rose.layers import SelfAttentionBlock, SwiGLUFFN
from rose.models.vision_transformer import init_weights_vit
from rose.utils import named_apply
...
def build_vision_model(
    ...
    if backbone is None:
        if backbone_model_config is not None:
            ...
            from rose.models import build_model_from_cfg as build_vision_backbone
