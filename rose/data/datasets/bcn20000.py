...
class BCN20K(Dermoscopy):
    ...
    def _entries_path(self):
        return f"bcn20000-entries-{self._split.value.upper()}.npy"
    ...
    def get_image_data(self, index: int) -> bytes:
        ...
        image_full_path = os.path.join(self.ssl_data, "bcn20000", entry["image_id"] + ".jpg")
