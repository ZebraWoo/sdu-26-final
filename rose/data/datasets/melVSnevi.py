...
class MNDICHD(Dermoscopy):
    ...
    def _entries_path(self):
        return f"mn-entries-{self._split.value.upper()}.npy"
    ...
    def get_image_data(self, index: int) -> bytes:
        ...
        image_full_path = os.path.join(self.ssl_data, "melanomaVSnevus", entry["image_id"] + ".jpg")
