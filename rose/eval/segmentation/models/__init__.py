...
from rose.eval.segmentation.models.backbone.dinov3_adapter import DINOv3_Adapter
from rose.eval.segmentation.models.heads.linear_head import LinearHead
from rose.eval.segmentation.models.heads.mask2former_head import Mask2FormerHead
from rose.eval.utils import ModelWithIntermediateLayers
...
def build_segmentation_decoder(
    ...
    if decoder_type == "m2f":
        ...
        backbone_model = ModelWithIntermediateLayers(
            backbone_model,
            n_last_blocks=backbone_indices_to_use,
