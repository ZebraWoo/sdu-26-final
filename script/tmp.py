...
if __name__ == "__main__":
    img_path = "/data/wenjing/skin_dataset/ssl/ssl_data/challenge2019/ISIC_0000000.jpg"
    ...
    for i in range(10):
        # 对图片应用增强
        enhanced_img = transfo(img)
        enhanced_img.save(f"/home/jiangwenjing/hd/dinov3/script/test/crop_flip_{i}.jpg")