...
from rose.layers.fp8_linear import convert_linears_to_fp8
from . import PanDerm_ViT as panderm
...
def build_model_for_eval(
    ...
    if pretrained_weights is None or pretrained_weights == "":
        ...
        from rose.checkpointer import load_checkpoint
        ...
        from rose.checkpointer import init_model_from_checkpoint_for_evals
