...
# Use timm's names
SSL_DEFAULT_MEAN = (0.688, 0.618, 0.596)
SSL_DEFAULT_STD = (0.357, 0.237, 0.249)
...
def make_normalize_transform(
    mean: Sequence[float] = SSL_DEFAULT_MEAN,
    std: Sequence[float] = SSL_DEFAULT_STD,
...
def make_classification_train_transform(
    *,
    ...
    transforms_list = [RandomGaussianResizedCrop(
        size=crop_size,
        scale=(0.32, 1.0),
