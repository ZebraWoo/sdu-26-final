...
from rose.data.transforms import SSL_DEFAULT_MEAN, SSL_DEFAULT_STD
from rose.eval.segmentation.models import BackboneLayersSet
from rose.eval.setup import ModelConfig


DEFAULT_MEAN = tuple(mean * 255 for mean in SSL_DEFAULT_MEAN)
DEFAULT_STD = tuple(std * 255 for std in SSL_DEFAULT_STD)
